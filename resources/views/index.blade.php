					...
					<?php
					  ...
					  ?>
						  <div class="col-md-3 col-sm-6">
							<a class="thumbnail" href="#"><img alt="{{ $featureproductsrow->title }}" src="{{ $image_url_arr[0] }}"></a>
	   ...
	   <?php
		...
		?>
			<div class="col-md-4 col-sm-6" style="max-height:300px;margin-bottom:20px">
				<a class="thumbnail" href="#"><img alt="{{ $allproductsrow->title }}" src="{{ $all_image_url_arr[0] }}">
