<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="row">
          <div class="banner-info">
            <div class="banner-logo text-center">
              <!-- <img src="<?php echo e(asset('https://keeno.app/web/assets/images/logo/logo.svg')); ?>" class="img-responsive"> -->
            </div>
			  ...
			  <div class="col-md-8 col-md-offset-2">
				  <div class="carousel slide media-carousel" id="topmedia">
					<div class="carousel-inner">
						  ...
						  ?>
							  <div class="col-md-6">
								<a class="thumbnail" href="#"><img alt="<?php echo e($categoriesrow->name); ?>" src="<?php echo e(asset('assets/img/category/').'/'.$categoriesrow->image_url); ?>"></a>
  ...
  <!--/ banner--><?php /**PATH E:\wamp64\www\keeno-test\resources\views/layout/partials/nav.blade.php ENDPATH**/ ?>